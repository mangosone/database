...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\French\French_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\German\German_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Korean\Korean_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Chinese\Chinese_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Taiwanese\Taiwanese_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Spanish\Spanish_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Spanish_South_American\SpanishSA_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Russian\Russian_CommandHelp.sql
echo  .... Creatures (2/14)
...
echo ^|_____________________________________________________________________________^|%colReset%
echo  .... Command (1/14)
%mysqlString% -D %wdb% < Translations\Translations\Italian\Italian_CommandHelp.sql
echo  .... Creatures (2/14)
