...
then
    ...
    do
        ...
        root_command "${repo_path}" "SOURCE ${docker_path}/Character/Updates/Rel21/${sql}" "character1";
    done
fi
...
then
    ...
    do
        echo "Importing Character update ${sql}";
        root_command "${repo_path}" "SOURCE ${docker_path}/Character/Updates/Rel22/${sql}" "character1";
    done
fi
...
then
    ...
    do
        echo "Importing World Update ${sql}";
        root_command "${repo_path}" "SOURCE ${docker_path}/World/Updates/Rel22/${sql}" "mangos1";
    done
fi
