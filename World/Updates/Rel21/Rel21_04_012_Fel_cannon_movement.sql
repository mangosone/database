...
BEGIN
    ...
    SET @cNewDescription = 'Fel_cannon_movement';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Fel_cannon_movement';
...
-- Legion Fel Cannon, Fel Cannon MKI
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE entry IN (21233, 22461);
DELETE FROM `creature_ai_scripts` WHERE `id` IN (2123300, 2123301, 2246100, 2246101, 19228123, 19228122);
