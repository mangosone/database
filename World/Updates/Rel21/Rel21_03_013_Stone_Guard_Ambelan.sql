...
BEGIN
    ...
    SET @cNewDescription = 'Stone_Guard_Ambelan';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Stone_Guard_Ambelan';
    ...
    -- Adds gossip to Stone Guard Ambelan
UPDATE `creature_template` SET `GossipMenuID`=0 WHERE `entry`=19332;
