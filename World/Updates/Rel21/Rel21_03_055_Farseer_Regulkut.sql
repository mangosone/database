...
BEGIN
    ...
    SET @cNewDescription = 'Farseer_Regulkut';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Farseer_Regulkut';
    ...
    -- Adds gossip to Far Seer Regulkut
UPDATE `creature_template` SET `GossipMenuID`=0 WHERE `entry`=16574;
