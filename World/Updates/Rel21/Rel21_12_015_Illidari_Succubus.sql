...
BEGIN
    ...
    SET @cNewDescription = 'Illidari Succubus';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Illidari Succubus';
...
-- Illidari Succubus
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` = 22860;
DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 22860;
