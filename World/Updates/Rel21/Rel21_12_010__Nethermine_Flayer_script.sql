...
BEGIN
    ...
    SET @cNewDescription = ' Nethermine Flayer script';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = ' Nethermine Flayer script';
...
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` = 23169;
DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 23169;
