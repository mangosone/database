...
BEGIN
    ...
    SET @cNewDescription = 'quest 9579';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'quest 9579';
...
DELETE FROM db_scripts WHERE id = 9579;
INSERT INTO `db_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `buddy_entry`, `search_radius`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES
(9579,0,10,17426,11000,0,0,0,0,0,0,0,-2089.37,-11298.1,63.54,5.689,'Galaen spawn'),
(9579,0,36,0,0,17426,50,0,0,0,0,0,0,0,0,0,'Face Player'),
