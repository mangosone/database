...
(@goguid+1,2086,0,1,-14703.9,450.831,0.656401,0.767712,0,0,0.374498,0.927228,25,255,1);
...
(55596,@poolentry+1,0,'Bloodsail Charts Point 2'),
...
(55597,@poolentry+2,0,'Bloodsail Orders Point 3');

-- Remove extra Bloodsail Orders.
DELETE FROM `gameobject` WHERE `guid` = 55598;
