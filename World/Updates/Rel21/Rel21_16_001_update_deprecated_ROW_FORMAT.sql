...
ALTER TABLE mail_level_reward ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE prospecting_loot_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE skill_discovery_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE skill_extra_item_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE spell_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
