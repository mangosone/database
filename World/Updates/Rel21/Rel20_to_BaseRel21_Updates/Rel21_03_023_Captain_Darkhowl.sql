...
BEGIN
    ...
    SET @cNewDescription = 'Captain_Darkhowl';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Captain_Darkhowl';
    ...
    -- Adds gossip to Captain Darkhowl
UPDATE `creature_template` SET `GossipMenuID`=0 WHERE `entry`=22107;
