...
BEGIN
    ...
    SET @cNewDescription = 'Apothecary_Zelana';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Apothecary_Zelana';
    ...
    -- Adds gossip to Apothecary Zelana
UPDATE `creature_template` SET `GossipMenuID`=0 WHERE `entry`=21257;
