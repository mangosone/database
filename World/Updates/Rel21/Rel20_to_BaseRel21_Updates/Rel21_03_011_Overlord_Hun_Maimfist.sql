...
BEGIN
    ...
    SET @cNewDescription = 'Overlord_Hun_Maimfist';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Overlord_Hun_Maimfist';
    ...
    -- Adds gossip to Overlord Hun Maimfist
UPDATE `creature_template` SET `GossipMenuID`=0 WHERE `entry`=16576;
