-- ----------------------------------------------------------------
-- Create the empty typed Warden check catalogue for a later redesign.
-- This schema-only transition intentionally includes no client checks,
-- addresses, modules, seeds, or other executable Warden material.
-- ----------------------------------------------------------------
...
BEGIN
    ...
    SET @cNewComment = 'Create empty typed Warden check catalogue';
