...
INSERT INTO `dbscripts_on_creature_death` (`id`, `delay`, `command`, `datalong`, `datalong2`, `buddy_entry`, `search_radius`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES (15355,1,15,10072,0,0,0,8,0,0,0,0,0,0,0,0,'drops small obsidian chunk'),
...
-- Dump completed on 2015-09-13  0:50:39
