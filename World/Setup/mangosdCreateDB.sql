CREATE DATABASE `mangos1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER, LOCK TABLES ON `mangos1`.* TO 'mangos'@'localhost';
