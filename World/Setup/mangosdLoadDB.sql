...
CREATE TABLE `areatrigger_teleport` (
  ...
  `required_item` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'Requested an item (See item_template.entry).',
  `required_item2` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'Requested an item (See item_template.entry).',
...
CREATE TABLE `creature_template` (
  ...
  `Scale` float NOT NULL DEFAULT '1' COMMENT 'The scale/size of the creature.<br />Normal => 1 (100%)',
  ...
  `RegenerateStats` tinyint(3) unsigned NOT NULL DEFAULT '3' COMMENT 'Controls if a creature template should regenerate it''s Health/Mana.',
  ...
  `AIName` char(64) NOT NULL DEFAULT '' COMMENT 'This string determines which built-in AI script will be used.',
  PRIMARY KEY (`Entry`)
...
CREATE TABLE `creature_template_classlevelstats` (
  ...
  `BaseHealthExp0` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'Base health value for expansion 0 aka. vanilla WoW.',
...
CREATE TABLE `item_loot_template` (
  ...
  `groupid` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'A group is a set of loot definitions.',
  `mincountOrRef` mediumint(9) NOT NULL DEFAULT '1' COMMENT 'The total number of copies of an item or may reference another loot template',
  `maxcount` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'For non-reference entries - the maximum number of copies of the item.',
  `condition_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'Value that represents a loot condition that must be filled.',
  PRIMARY KEY (`entry`,`item`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Loot System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `npc_text` (
  ...
  `em0_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Emote to play when text is displayed.',
  `em0_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em0_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed',
  ...
  `em1_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em1_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em1_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
  ...
  `em2_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em2_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em2_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
  ...
  `em3_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em3_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em3_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
  ...
  `em4_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em4_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em4_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
  ...
  `em5_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em5_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em5_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
  ...
  `em6_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em6_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em6_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
  ...
  `em7_0` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'emote to play when text is displayed.',
  `em7_1` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Second emote to play when text is displayed.',
  `em7_2` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Third emote to play when text is displayed.',
...
CREATE TABLE `quest_template` (
  ...
  `QuestLevel` smallint(6) NOT NULL DEFAULT '0' COMMENT 'The quest''s level.',
