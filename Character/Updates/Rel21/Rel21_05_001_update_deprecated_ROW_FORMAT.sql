...
BEGIN
    ...
    -- New Values
    SET @cNewVersion = '21';
    SET @cNewStructure = '05'; -- If The Update contains any 'ALTER DATABASE' statements, increment this and set cNewContent to 001
    SET @cNewContent = '001';
...
ALTER TABLE character_declinedname ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE character_pet_declinedname ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE character_queststatus ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE character_queststatus_daily ROW_FORMAT=DYNAMIC ENGINE=INNODB;
